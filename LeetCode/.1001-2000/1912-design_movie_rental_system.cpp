...
// https://leetcode.com/problems/design-movie-rental-system/discuss/1298735/C%2B%2B-Vector%2BOrdered-Sets
// 抄的
class MovieRentingSystem
{
	// 还没借出去的
	set<pair<int, int>> avail[10010];
	// 商店、电影、价格
